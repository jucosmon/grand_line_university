...
<body>
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                ...
                <div class="main-button">
                    <div class="scroll-to-section"><a href="#section6">Login</a></div>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-4 col-12">
                    <div class="features-post third-features">
                        <div class="features-content">
                            ...
                            <div class="content-hide">
                                <p>Elevate your learning experience with real-time meetings at Grand Line University,
                                    where
                                    interactive discussions and expert guidance propel your academic journey forward.
                                </p>
                                <div class="scroll-to-section"><a href="#section2">More Info</a></div>
                            </div>
                        </div>
                        ...
                        <section class='tabs-content'>
                            <article id='tabs-1'>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p>Grand Line University is where students embark on exciting educational
                                            journeys,
                                            inspired by the legendary Grand Line's spirit of adventure. Here, ambition
                                            thrives, and students are encouraged to explore their passions and unlock
                                            their
                            ...
                            <article id='tabs-2'>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <h4>Top Level</h4>
                                        <p>At Grand Line University, excellence is not just a goal—it's a way of life.
                                            With
                                            a distinguished faculty and visionary leadership, the university sets the
                                            standard for academic excellence and innovation. From top-tier
                                            administrators to
                                            dedicated educators, every aspect of the institution is meticulously curated
                                            to
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p>Grand Line University prides itself on providing top-notch resources and
                                            ...
                                            succeed. From state-of-the-art meeting rooms equipped with the latest
                                            technology
                                            to comprehensive research facilities, the university spares no effort in
                                            delivering a high-quality learning environment. With a commitment to
                                            excellence
                                            in every aspect, Grand Line University empowers students to thrive and excel
                                            in
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p><i class="fa fa-copyright"></i> Grand Line University 2024 </p>
                </div>
            </div>
        </div>
    </footer>
